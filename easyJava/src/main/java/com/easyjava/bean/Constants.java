...
public class Constants {
    ...
    public static boolean BUILD_BASE_JAVA_BEAN = false;
     ...
     * 忽略构建的包
     */
    public static String IGNORE_BUILD;

    static {
        PACKAGE_BASE = PropertiesUtils.getString("package.base");
        PACKAGE_BEAN = PACKAGE_BASE + "." + PropertiesUtils.getString("package.bean");
        BUILD_BASE_JAVA_BEAN = Boolean.parseBoolean(PropertiesUtils.getString("build.base.java.bean"));
        ...
        // 忽略构建的包
        IGNORE_BUILD = PropertiesUtils.getString("ignore.build");
    }
